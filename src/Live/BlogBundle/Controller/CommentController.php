...
use Live\BlogBundle\Entity\Comment;
use Live\BlogBundle\Form\CommentType;
...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LiveBlogBundle:Comment')->findAll();
     ...
     * @Method("POST")
     * @Template("LiveBlogBundle:Comment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LiveBlogBundle:Comment')->find($id);
     ...
     * @Method("PUT")
     * @Template("LiveBlogBundle:Comment:edit.html.twig")
     */
